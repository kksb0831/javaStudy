...
public class CalendarMain {
    public static void main(String[] args) {
        ...
        System.out.println("▷ 현재시각 1 => " + date);
        // ▷ 현재시각 1 => Wed Jan 20 15:45:52 KST 2021
        System.out.println("▷ 현재시각 2 => " + sdformat.format(date));
        // ▷ 현재시각 2 => 2021-01-20 15:45:52

        String currnetTime = String.format("%tF %tT %tA %tZ",date,date,date,date);

        System.out.println("▷ 현재시각 3 => " + currnetTime);
        // ▷ 현재시각 3 => 2021-01-20 15:45:52 수요일
